<template>
  ...
  >
    <h1 class="font-bold text-xl">Dependencias</h1>
    <div>
      <el-button
        plain
        type="warning"
...
const { createNewDependence } = useDependenceStore()
const DependenceStore = useDependenceStore();
const { loadingPage } = storeToRefs(DependenceStore);
</script>